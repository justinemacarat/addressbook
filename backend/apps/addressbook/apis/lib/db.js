...
// Custom modules
const mysql = require(`${CONSTANTS.APPROOTDIR}/addressbook/3p/node_modules/mysql`);
const utils = require("./utils");
const mysqlConfig = require(`${CONSTANTS.APPROOTDIR}/addressbook/conf/config`).MYSQL;
